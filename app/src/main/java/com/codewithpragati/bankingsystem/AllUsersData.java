...
public class AllUsersData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.all_users_data);
    ...
    private void showData() {
        ...
        adapter = new CustomeAdapter_userlist(AllUsersData.this, modelList_showlist);
    ...
    public void nextActivity(int position) {
        ...
        Intent intent = new Intent(AllUsersData.this, SingleUserData.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()==R.id.action_history){
            startActivity(new Intent(AllUsersData.this, TransactionHistory.class));
        }
