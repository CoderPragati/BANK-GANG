...
public class CustomeAdapter_userlist extends RecyclerView.Adapter<ViewHolder> {
    ...
    AllUsersData UserList;
    List<Model> modelList;
    Context context;

    public CustomeAdapter_userlist(AllUsersData userList, List<Model> modelList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_userslist, parent, false);
