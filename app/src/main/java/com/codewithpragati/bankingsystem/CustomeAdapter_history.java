...
public class CustomeAdapter_history extends RecyclerView.Adapter<ViewHolder> {
    ...
    public CustomeAdapter_history(TransactionHistory historyList, List<Model> modelList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_transaction_history, parent, false);
